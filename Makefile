...
emu_apps:
	...
	odin build apps/spin -target:freestanding_riscv64 -build-mode:object -default-to-nil-allocator -no-thread-local -no-rpath -no-crt -o:none -out:apps/bin/spin.o
	riscv64-none-elf-ld -T sdk/app/link.ld apps/bin/spin-* apps/bin/syscall.o -o apps/bin/spin.elf
